...
function ListInfo() {
    return(
        <ListInfoStack.Navigator screenOptions={{headerShown: false}}>
            <ListInfoStack.Screen name="AccountInfo" component={AccountInfo} />
            <ListInfoStack.Screen name="ChangeInfo" component={ChangeInfo} />
...
function Account() {
    return(
        <AccountStack.Navigator screenOptions={{headerShown: false}}>
            ...
            <AccountStack.Screen name="ListInfo" component={ListInfo} />
            <AccountStack.Screen  name="SettingAcc" component={SettingAcc} />
...
function ChatRoute() {
    return(
        <ChatStack.Navigator  screenOptions={{headerShown: false}}>
            ...
            <ChatStack.Screen name="MessLine" component={MessLine}/>
        </ChatStack.Navigator>
    )
}
...
function MainTab () {
    return (
        ...
        >
            ...
            />
            <Tab.Screen  name="Trò chuyện" component={ChatRoute}
                options = {{
                    tabBarIcon: ({ color, size }) => 
                    (
                        <MaterialCommunityIcons 
