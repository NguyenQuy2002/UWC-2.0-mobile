...
import { Image, ScrollView, View, StyleSheet, Text, Pressable, StatusBar, TextInput } from 'react-native';
    ...
    return (
        <View style={styles.message}>
            <View style={styles.container}>
                ...
                <Image style={styles.active1} source={require('../../assets/active.png')}/>
            </View>
    ...
    return (
        <View style={styles.body}>
            ...
            <ScrollView style={styles.main}>
                <MessageReceive 
                    mess="Hôm nay làm dùm tui ca này được không vậy Quý"
                />
                <MessageSend 
                    mess="okk, 0967514105 momo 200k dùm nha bạn A"
                />
                <MessageReceive 
                    mess={mess}
                />
